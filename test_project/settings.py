...
DATABASES = {
    'default': dj_database_url.parse(
        os.environ.get(
            "DATABASE_URL",
            "postgresql://neondb_owner:npg_A0fx8VFCWOQB@ep-divine-pond-anvyu1b4-pooler.c-6.us-east-1.aws.neon.tech/neondb?sslmode=require"
        )
    )
}
# DATABASES = {
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'caloriesfix198@gmail.com'  # الايميل الجديد
EMAIL_HOST_PASSWORD = 'renwdotfktdhwlyl'  # App Password 16 حرف بدون فراغات
STATIC_URL = 'static/'
